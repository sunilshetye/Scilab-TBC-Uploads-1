...
mprintf("(i)The lattice parameter is = %1.3f nm\n",a)
...
a=d_110*sqrt(h^2+k^2+l^2)
mprintf("(ii)The lattice parameter is = %1.4f nm\n",a)
mprintf("The lattice parameter is consistent at value=0.296 nm\n") //by multiplying d_110 by sqrt(3) and d_200 by sqrt(4)

//for atomice diameter we have
a=0.296 //lattice parameter in nm
D=a/sqrt(2)
mprintf("(iii)The atomic diameter is = %1.4f nm",D) 
